...
| `Results` | [`List<WordDetails>`](../../doc/models/word-details.md) | Required | This field contains detailed information of the word. | List<WordDetails> getResults() | setResults(List<WordDetails> results) |
| `Pronunciation` | `Object` | Optional | This model contains pronunciation details of a specific word. | Object getPronunciation() | setPronunciation(Object pronunciation) |
| `Frequency` | `Double` | Optional | The frequency of the word usage. | Double getFrequency() | setFrequency(Double frequency) |
| `Syllables` | [`SyllableDetails`](../../doc/models/syllable-details.md) | Optional | This custom type contains the syllable details for word API. | SyllableDetails getSyllables() | setSyllables(SyllableDetails syllables) |
